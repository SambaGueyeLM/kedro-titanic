...
# test_kedro_titanic documentation build
...
from test_kedro_titanic import __version__ as release

# -- Project information -----------------------------------------------------

project = "test_kedro_titanic"
author = "Kedro"
...
htmlhelp_basename = "test_kedro_titanicdoc"
...
latex_documents = [
    (
        master_doc,
        "test_kedro_titanic.tex",
        "test_kedro_titanic Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "test_kedro_titanic",
        "Project test_kedro_titanic codebase.",
        "Data-Science",
    )
]
